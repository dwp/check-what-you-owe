...
router.post('/views/repayment-plan/repayment-amount', function (req, res) {
  ...
  if (answer <= 10) {
    res.redirect('/prototypes/18/views/repayment-plan/repayment-calculator/small')
  }

  if (answer >= 11) {
    res.redirect('/prototypes/18/views/repayment-plan/repayment-plan-summary')
  }
})
...
router.post('/views/repayment-plan/what-do-you-want-to-do', function (req, res) {
  ...
  if (submitted['initial-payment'] === 'false') {
    res.redirect('/prototypes/18/views/repayment-plan/initial-payment-amount')
  }

  if (submitted['initial-payment'] === 'true') {
    res.redirect('/prototypes/18/views/repayment-plan/repayment-amount')
  }
})
...
router.post('/views/repayment-plan/initial-payment-amount', function (req, res) {
  ...
  if (answer <= 999999999999) {
    res.redirect('/prototypes/18/views/repayment-plan/initial-payment-summary')
  }
})
...
router.post('/views/repayment-plan/repayment-amount', function (req, res) {
  ...
  if (answer <= 9) {
    res.redirect('/prototypes/18/views/repayment-plan/repayment-amount-result/contact-us--monthly')
  }
...
router.post('/views/repayment-plan/repayment-amount/monthly-lump-sum', function (req, res) {
  ...
  if (answer <= 9) {
    res.redirect('/prototypes/18/views/repayment-plan/repayment-amount-result/amount-too-low--monthly-lump-sum')
  }

  if (answer >= 10) {
    res.redirect('/prototypes/18/views/repayment-plan/repayment-plan-summary/monthly')
  }
