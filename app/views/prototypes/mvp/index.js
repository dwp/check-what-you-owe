...
router.post('/views/additional-payments/additional-payment/additional-payment-calculator', function (req, res) {
  ...
  if (answer <= mvp0) {
    res.redirect('/prototypes/mvp/views/additional-payments/additional-payment/small')
  }

  if (answer <= 250) {
    res.redirect('/prototypes/mvp/views/additional-payments/additional-payment/medium')
  }

  if (answer >= 251) {
    res.redirect('/prototypes/mvp/views/additional-payments/additional-payment/large')
  }
})
...
router.post('/views/repayment-plan/initial-payment', function (req, res) {
  ...
  if (submitted['initial-payment'] === 'false') {
    res.redirect('/prototypes/mvp/views/repayment-plan/initial-payment-amount')
  }

  if (submitted['initial-payment'] === 'true') {
    res.redirect('/prototypes/mvp/views/repayment-plan/what-is-your-take-home-pay/no-lump-sum')
  }
})
...
router.post('/views/repayment-plan/initial-payment-amount', function (req, res) {
  ...
  if (answer <= 999999999999) {
    res.redirect('/prototypes/mvp/views/repayment-plan/what-is-your-take-home-pay/lump-sum')
  }
})
...
router.post('/views/repayment-plan/what-is-your-take-home-pay/lump-sum', function (req, res) {
  ...
  if (answer <= 9999999999) {
    res.redirect('/prototypes/mvp/views/repayment-plan/repayment-amount/monthly-lump-sum')
  }
})
...
router.post('/views/repayment-plan/what-is-your-take-home-pay/no-lump-sum', function (req, res) {
  ...
  if (answer <= 9999999999) {
    res.redirect('/prototypes/mvp/views/repayment-plan/repayment-amount/monthly')
  }
})
...
router.post('/views/repayment-plan/what-is-your-take-home-pay/lump-sum', function (req, res) {
  ...
  if (submitted['take-home-pay'] === 'take-home-pay-1') {
    res.redirect('/prototypes/mvp/views/repayment-plan/repayment-frequency-lump-sum')
  }
...
router.post('/views/repayment-plan/repayment-frequency', function (req, res) {
  ...
  if (submitted['payment-frequency'] === 'fortnightly') {
    res.redirect('/prototypes/mvp/views/repayment-plan/repayment-amount/fortnightly')
  }

  if (submitted['payment-frequency'] === 'weekly') {
    res.redirect('/prototypes/mvp/views/repayment-plan/repayment-amount/weekly')
  }
})
...
router.post('/views/repayment-plan/repayment-frequency-lump-sum', function (req, res) {
  ...
  if (submitted['payment-frequency'] === 'fortnightly') {
    res.redirect('/prototypes/mvp/views/repayment-plan/repayment-amount/fortnightly-lump-sum')
  }

  if (submitted['payment-frequency'] === 'weekly') {
    res.redirect('/prototypes/mvp/views/repayment-plan/repayment-amount/weekly-lump-sum')
  }
})
...
router.post('/views/repayment-plan/repayment-amount/monthly', function (req, res) {
  ...
  if (answer <= 49) {
    res.redirect('/prototypes/mvp/views/repayment-plan/repayment-amount-result/amount-too-low--monthly')
  }

  if (answer <= 74) {
    res.redirect('/prototypes/mvp/views/repayment-plan/repayment-plan-summary/monthly')
  }

  if (answer >= 75) {
    res.redirect('/prototypes/mvp/views/repayment-plan/repayment-amount-result/amount-too-high--monthly')
  }
})
...
router.post('/views/repayment-plan/repayment-amount/monthly-lump-sum', function (req, res) {
  ...
  if (answer <= 49) {
    res.redirect('/prototypes/mvp/views/repayment-plan/initial-payment-summary')
  }
...
router.post('/views/repayment-plan/repayment-amount-result/amount-too-low--monthly', function (req, res) {
  ...
  if (submitted['can-you-pay-50'] === 'can-you-pay-50-no') {
    res.redirect('/prototypes/mvp/views/repayment-plan/repayment-amount-result/contact-us--monthly')
  }
})
