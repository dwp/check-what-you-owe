...
router.post('/views/additional-payments/additional-payment/additional-payment-calculator', function (req, res) {
  ...
  if (answer <= 110) {
    res.redirect('/prototypes/mvp2/views/additional-payments/additional-payment/small')
  }

  if (answer <= 250) {
    res.redirect('/prototypes/mvp2/views/additional-payments/additional-payment/medium')
  }

  if (answer >= 251) {
    res.redirect('/prototypes/mvp2/views/additional-payments/additional-payment/large')
  }
})
...
router.post('/views/repayment-plan/what-do-you-want-to-do', function (req, res) {
  ...
  if (submitted['initial-payment'] === 'false') {
    res.redirect('/prototypes/mvp2/views/repayment-plan/initial-payment-amount')
  }

  if (submitted['initial-payment'] === 'true') {
    res.redirect('/prototypes/mvp2/views/repayment-plan/repayment-amount')
  }
})
...
router.post('/views/repayment-plan/initial-payment-amount', function (req, res) {
  ...
  if (answer <= 999999999999) {
    res.redirect('/prototypes/mvp2/views/repayment-plan/initial-payment-summary')
  }
})
